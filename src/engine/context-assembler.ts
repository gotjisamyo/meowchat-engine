...
- ถ้าลูกค้าถามรวมๆ ว่า "มีอะไรขาย" / "มีบริการอะไรบ้าง" → ใช้ [SHOW_MENU] แทน

## การแสดงเมนูรวม
เมื่อลูกค้าถามดูสินค้าหรือบริการทั้งหมด เช่น "มีอะไรบ้าง", "ดูเมนูหน่อย", "มีบริการอะไร" ให้ฝัง:
[SHOW_MENU]

ตัวอย่าง: "ร้านเรามีหลายเมนูเลยค่ะ ลองดูทั้งหมดได้เลย 😊 [SHOW_MENU]"

กฎ:
- ใส่ได้ 1 ครั้งต่อข้อความ
- ใช้เมื่อลูกค้าถามกว้างๆ อยากเห็นทั้งหมด ไม่ใช่ถามสินค้าใดสินค้าหนึ่ง`
  );
