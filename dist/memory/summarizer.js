...
exports.endOfSessionSummary = endOfSessionSummary;
...
async function summarizeMemory(existingSummary, evictedTurn) {
...
ถ้าไม่มีข้อมูลสำคัญ ตอบว่า: (ไม่มีข้อมูลสำคัญ)`,
    ...
    if (text === "(ไม่มีข้อมูลสำคัญ)" || text === "")
        return existingSummary;
    return text;
}
// ─── End-of-session summary ───────────────────────────────────────────────────
async function endOfSessionSummary(fullSummary, currentWindow) {
